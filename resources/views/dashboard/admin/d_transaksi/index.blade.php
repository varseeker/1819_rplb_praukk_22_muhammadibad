...
<body>
    ...
    <div class="container">
        <table class="table">
            <tr>
                <td>
                    <h1 class="user-select-none mt-4">Data Pesanan</h1>
                    <p class="user-select-none mb-2">Berikut adalah Index data untuk semua Data Pesanan. </p>
                </td>
                <td>
                    <center><a name="" id="" class="btn btn-primary mt-5" href="pesanan/add" role="button">Tambah Data</a></center>
                </td>
                <td>
                    <center><a name="" id="" class="btn btn-primary mt-5" href="pesanan/laporan" role="button">Cetak Laporan Data</a></center>
                </td>
            </tr>
        </table>
        @if (session('status'))
                ...
                <table class="table table-striped table-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $transaksis->id }}</td>
                            <td>{{ $transaksis->customer->nama }}</td>
                            <td>{{ $transaksis->status }}</td>
                            <td>{{ $transaksis->dibayar }}</td>
                            <td>{{ $transaksis->total }}</td>
                            <td>
                                <a href="pesanan/{{ $transaksis->id }}/show" class="badge badge-primary">Show</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
